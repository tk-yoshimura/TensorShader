...
namespace TensorShader.Operators.ComplexConvolution {
    ...
    internal class ComplexDeconvolution2D : Operator {
        ...
        public ComplexDeconvolution2D(int outwidth, int outheight, int inchannels, int outchannels, int kwidth, int kheight, bool gradmode = false, int batch = 1) {
            if (inchannels % 2 != 0) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderCudaBackend.Complex.Deconvolution2D((uint)InChannels, (uint)OutChannels,
