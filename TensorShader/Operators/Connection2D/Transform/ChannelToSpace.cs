...
namespace TensorShader.Operators.Connection2D {
    ...
    internal class ChannelToSpace : Operator {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderCudaBackend.Transform.ChannelToSpace2D((uint)OutChannels, (uint)inmap.Width, (uint)inmap.Height, (uint)Batch, (uint)Scale, inmap.Buffer, outmap.Buffer);
        }
