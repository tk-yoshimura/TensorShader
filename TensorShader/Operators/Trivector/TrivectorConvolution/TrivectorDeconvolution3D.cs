...
namespace TensorShader.Operators.TrivectorConvolution {
    ...
    internal class TrivectorDeconvolution3D : Operator {
        ...
        public TrivectorDeconvolution3D(int outwidth, int outheight, int outdepth, int inchannels, int outchannels, int kwidth, int kheight, int kdepth, bool gradmode = false, int batch = 1) {
            if (inchannels % 3 != 0) {
