...
namespace TensorShader.Operators.Connection3D {
    ...
    internal class StridePooling : Operator {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderCudaBackend.Pool.StridePool3D((uint)Channels, (uint)inmap.Width, (uint)inmap.Height, (uint)inmap.Depth, (uint)Batch, (uint)Stride, inmap.Buffer, outmap.Buffer);
        }
