...
namespace TensorShader.Operators.Connection3D {
    ...
    internal class AverageUnpooling : Operator {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderCudaBackend.Pool.AverageUnpool3D((uint)Channels, (uint)outmap.Width, (uint)outmap.Height, (uint)outmap.Depth, (uint)Batch, (uint)Stride, inmap.Buffer, outmap.Buffer);
        }
