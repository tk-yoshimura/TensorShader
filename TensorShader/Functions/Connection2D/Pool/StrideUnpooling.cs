...
namespace TensorShader {
    public abstract partial class VariableNode {
        /// <summary>2次元ストライド逆プーリング</summary>
        public static VariableNode StrideUnpooling2D(VariableNode x, int stride, Shape outshape = null) {
            if (outshape is null) {
            ...
            Function function =
                new Functions.Connection2D.StrideUnpooling(outshape, stride);
    ...
    public partial class Tensor {
        /// <summary>2次元ストライド逆プーリング</summary>
        public static Tensor StrideUnpooling2D(Tensor x, int stride, Shape outshape = null) {
            if (outshape is null) {
                int outwidth = x.Shape.Width * stride;
                int outheight = x.Shape.Height * stride;
    ...
    internal class StrideUnpooling : Function {
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], outtensors[0] },
                    new Operators.Connection2D.StrideUnpooling(
