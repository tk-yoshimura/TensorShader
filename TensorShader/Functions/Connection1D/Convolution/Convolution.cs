...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode Convolution1D(VariableNode x, VariableNode w) {
            Function function =
                new Functions.Connection1D.Convolution(x.Shape, w.Shape);
    ...
    public partial class Tensor {
        /// <summary>1次元畳み込み</summary>
        public static Tensor Convolution1D(Tensor x, Tensor w) {
