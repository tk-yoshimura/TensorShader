...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode StridePooling3D(VariableNode x, int stride) {
            Function function =
                new Functions.Connection3D.StridePooling(stride);
    ...
    public partial class Tensor {
        /// <summary>3次元ストライドプーリング</summary>
        public static Tensor StridePooling3D(Tensor x, int stride) {
            Function function =
                new Functions.Connection3D.StridePooling(stride);
    ...
    internal class StridePooling : Function {
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], outtensors[0] },
                    new Operators.Connection3D.StridePooling(
