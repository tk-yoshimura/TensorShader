...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode TrivectorDeconvolution1D(VariableNode x, VariableNode w, bool gradmode = false) {
            Function function =
                new Functions.TrivectorConvolution.TrivectorDeconvolution1D(x.Shape, w.Shape, gradmode);
    ...
    public partial class Tensor {
        /// <summary>3次元ベクトル1次元逆畳み込み</summary>
        public static Tensor TrivectorDeconvolution1D(Tensor x, Tensor w, bool gradmode = false) {
...
namespace TensorShader.Functions.TrivectorConvolution {
    ...
    internal class TrivectorDeconvolution1D : Function {
        ...
        public TrivectorDeconvolution1D(Shape inshape, Shape kernelshape, bool gradmode)
            ...
            this.OutShape = Shape.Map1D(kernelshape.InChannels / 4 * 3, outwidth, inshape.Batch);
