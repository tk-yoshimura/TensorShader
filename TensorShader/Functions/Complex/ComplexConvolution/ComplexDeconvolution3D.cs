...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ComplexDeconvolution3D(VariableNode x, VariableNode w, bool gradmode = false) {
            Function function =
                new Functions.ComplexConvolution.ComplexDeconvolution3D(x.Shape, w.Shape, gradmode);
    ...
    public partial class Tensor {
        /// <summary>複素3次元逆畳み込み</summary>
        public static Tensor ComplexDeconvolution3D(Tensor x, Tensor w, bool gradmode = false) {
...
namespace TensorShader.Functions.ComplexConvolution {
    ...
    internal class ComplexDeconvolution3D : Function {
        ...
        public ComplexDeconvolution3D(Shape inshape, Shape kernelshape, bool gradmode)
