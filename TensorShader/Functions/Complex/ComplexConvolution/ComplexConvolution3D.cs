...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ComplexConvolution3D(VariableNode x, VariableNode w, bool gradmode = false) {
            Function function =
                new Functions.ComplexConvolution.ComplexConvolution3D(x.Shape, w.Shape, gradmode);
    ...
    public partial class Tensor {
        /// <summary>複素3次元畳み込み</summary>
        public static Tensor ComplexConvolution3D(Tensor x, Tensor w, bool gradmode = false) {
...
namespace TensorShader.Functions.ComplexConvolution {
    ...
    internal class ComplexConvolution3D : Function {
        ...
        public ComplexConvolution3D(Shape inshape, Shape kernelshape, bool gradmode)
