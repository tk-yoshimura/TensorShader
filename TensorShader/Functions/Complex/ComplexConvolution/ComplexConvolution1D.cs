...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ComplexConvolution1D(VariableNode x, VariableNode w, bool gradmode = false) {
            Function function =
                new Functions.ComplexConvolution.ComplexConvolution1D(x.Shape, w.Shape, gradmode);
    ...
    public partial class Tensor {
        /// <summary>複素1次元畳み込み</summary>
        public static Tensor ComplexConvolution1D(Tensor x, Tensor w, bool gradmode = false) {
...
namespace TensorShader.Functions.ComplexConvolution {
    ...
    internal class ComplexConvolution1D : Function {
        ...
        public ComplexConvolution1D(Shape inshape, Shape kernelshape, bool gradmode)
