...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ComplexDeconvolution1D(VariableNode x, VariableNode w, bool gradmode = false) {
            Function function =
                new Functions.ComplexConvolution.ComplexDeconvolution1D(x.Shape, w.Shape, gradmode);
    ...
    public partial class Tensor {
        /// <summary>複素1次元逆畳み込み</summary>
        public static Tensor ComplexDeconvolution1D(Tensor x, Tensor w, bool gradmode = false) {
...
namespace TensorShader.Functions.ComplexConvolution {
    ...
    internal class ComplexDeconvolution1D : Function {
        ...
        public ComplexDeconvolution1D(Shape inshape, Shape kernelshape, bool gradmode)
            ...
            if (kernelshape.Type != ShapeType.Kernel || kernelshape.Ndim != 3) {
                throw new ArgumentException(ExceptionMessage.ShapeElements(kernelshape, ("Ndim", 3), ("Type", ShapeType.Kernel)));
            }
            ...
            if (inshape.Channels / 2 != kernelshape.OutChannels) {
                throw new ArgumentException(ExceptionMessage.ShapeElements(kernelshape, ("OutChannels", inshape.Channels / 2)));
            }
