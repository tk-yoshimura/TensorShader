...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode QuaternionConvolution2D(VariableNode x, VariableNode w, bool gradmode = false) {
            Function function =
                new Functions.QuaternionConvolution.QuaternionConvolution2D(x.Shape, w.Shape, gradmode);
    ...
    public partial class Tensor {
        /// <summary>四元数2次元畳み込み</summary>
        public static Tensor QuaternionConvolution2D(Tensor x, Tensor w, bool gradmode = false) {
...
namespace TensorShader.Functions.QuaternionConvolution {
    ...
    internal class QuaternionConvolution2D : Function {
        ...
        public QuaternionConvolution2D(Shape inshape, Shape kernelshape, bool gradmode) :
