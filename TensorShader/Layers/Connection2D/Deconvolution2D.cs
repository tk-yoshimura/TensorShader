...
namespace TensorShader.Layers {
    ...
    public class Deconvolution2D : Layer {
        ...
        public Deconvolution2D(int inchannels, int outchannels, int kwidth, int kheight, bool use_bias, PaddingMode pad_mode, string label)
            : base(label) {
