...
namespace TensorShader.Layers {
    ...
    public class ComplexConvolution2D : Layer {
        ...
        public ComplexConvolution2D(int inchannels, int outchannels, int kwidth, int kheight, bool use_bias, PaddingMode pad_mode, string label)
            : base(label) {
        ...
        public Field Forward(Field x) {
            ...
            Field y = ComplexConvolution2D(x, W);
