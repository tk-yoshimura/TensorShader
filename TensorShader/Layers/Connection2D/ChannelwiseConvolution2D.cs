...
namespace TensorShader.Layers {
    ...
    public class ChannelwiseConvolution2D : Layer {
        ...
        public ChannelwiseConvolution2D(int channels, int kwidth, int kheight, int stride, bool use_bias, PaddingMode pad_mode, string label)
            : base(label) {
        ...
        public Field Forward(Field x) {
            ...
            Field y = ChannelwiseConvolution2D(x, W, Stride);
