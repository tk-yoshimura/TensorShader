...
namespace TensorShader.Layers {
    ...
    public class TrivectorDeconvolution2D : Layer {
        ...
        public TrivectorDeconvolution2D(int inchannels, int outchannels, int kwidth, int kheight, bool use_bias, PaddingMode pad_mode, string label)
            : base(label) {
        ...
        public Field Forward(Field x) {
            Field y = TrivectorDeconvolution2D(x, W);
