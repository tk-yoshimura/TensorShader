...
namespace TensorShader.Layers {
    ...
    public class ChannelwiseDeconvolution3D : Layer {
        ...
        public ChannelwiseDeconvolution3D(int channels, int kwidth, int kheight, int kdepth, int stride, bool use_bias, PaddingMode pad_mode, string label)
            : base(label) {
        ...
        public Field Forward(Field x) {
            Field y = ChannelwiseDeconvolution3D(x, W, Stride);
