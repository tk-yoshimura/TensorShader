...
namespace TensorShader.Layers {
    ...
    public class ChannelwiseConvolution3D : Layer {
        ...
        public ChannelwiseConvolution3D(int channels, int kwidth, int kheight, int kdepth, bool use_bias, PaddingMode pad_mode, string label)
            : base(label) {
        ...
        public Field Forward(Field x) {
            ...
            Field y = ChannelwiseConvolution3D(x, W);
