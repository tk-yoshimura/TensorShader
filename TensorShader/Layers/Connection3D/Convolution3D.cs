...
namespace TensorShader.Layers {
    ...
    public class Convolution3D : Layer {
        /// <summary>重み</summary>
        ...
        public Convolution3D(int inchannels, int outchannels, int kwidth, int kheight, int kdepth, bool use_bias, PaddingMode pad_mode, string label)
            : base(label) {
            this.W = new ParameterField(
                Shape.Kernel3D(inchannels, outchannels, kwidth, kheight, kdepth),
                Label + "/w",
