...
namespace TensorShader.Layers {
    ...
    public class TrivectorConvolution1D : Layer {
        ...
        public TrivectorConvolution1D(int inchannels, int outchannels, int kwidth, int stride, bool use_bias, PaddingMode pad_mode, string label)
            : base(label) {
        ...
        public Field Forward(Field x) {
            ...
            Field y = TrivectorConvolution1D(x, W, Stride);
