...
namespace TensorShader.Layers {
    ...
    public class ComplexConvolution1D : Layer {
        ...
        public ComplexConvolution1D(int inchannels, int outchannels, int kwidth, int stride, bool use_bias, PaddingMode pad_mode, string label)
            : base(label) {
        ...
        public Field Forward(Field x) {
            ...
            Field y = ComplexConvolution1D(x, W, Stride);
