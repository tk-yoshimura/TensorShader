...
namespace TensorShader.Layers {
    ...
    public class QuaternionDeconvolution1D : Layer {
        ...
        public QuaternionDeconvolution1D(int inchannels, int outchannels, int kwidth, int stride, bool use_bias, PaddingMode pad_mode, string label)
            : base(label) {
        ...
        public Field Forward(Field x) {
            Field y = QuaternionDeconvolution1D(x, W, Stride);
