...
namespace TensorShader.Layers {
    ...
    public class PointwiseConvolution1D : Layer {
        /// <summary>重み</summary>
        ...
        public PointwiseConvolution1D(int inchannels, int outchannels, bool use_bias, string label)
            : base(label) {
        ...
        public Field Forward(Field x) {
            Field y = PointwiseConvolution1D(x, W);
