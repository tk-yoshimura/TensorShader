...
namespace TensorShaderCudaBackend.Shaders.ArrayManipulation {
    ...
    public sealed class SortNoStrideUnuseSharedMemory : Shader {
        ...
        public SortNoStrideUnuseSharedMemory() {
            string code = $@"
        ...
        protected override sealed void CheckArgument(params object[] args) {
            ...
            if (!(args[2] is uint axislength) || axislength < 1) {
                throw new ArgumentException(nameof(axislength));
            }

            if (!(args[3] is uint slides) || slides < 0) {
