...
namespace TensorShaderCudaBackend.Shaders.Trivector.Convolution.FloatPrecision {
    ...
    public sealed class Convolution3D : Shader {
        ...
        public Convolution3D(uint inchannels, uint outchannels, uint kwidth, uint kheight, uint kdepth, bool gradmode) {
            ...
            __global__ void trivector_convolution_3d(const float3* __restrict__ inmap, float3* __restrict__ outmap, const float4* __restrict__ filter,
        ...
        public override void Execute(Stream stream, params object[] args) {
            ...
            CudaArray<float> transpose_filter =
                WorkspaceReserver<float>.Request(stream, filter.DeviceID, index: 0, InChannels * OutChannels * KernelWidth * KernelHeight * KernelDepth * 4);
