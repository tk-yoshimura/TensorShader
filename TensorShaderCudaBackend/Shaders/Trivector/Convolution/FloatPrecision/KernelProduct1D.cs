...
namespace TensorShaderCudaBackend.Shaders.Trivector.Convolution.FloatPrecision {
    ...
    public sealed class KernelProduct1D : Shader {
        ...
        public KernelProduct1D(uint inchannels, uint outchannels, uint kwidth, bool transpose) {
            ...
            __global__ void trivector_kernelproduct_1d(const float3* __restrict__ inmap, const float3* __restrict__ outmap, 
        ...
        public override void Execute(Stream stream, params object[] args) {
            ...
            filter_grad.ZerosetAsync(stream, InChannels * OutChannels * KernelWidth * 4);
        ...
        protected override void CheckArgument(params object[] args) {
            ...
            if (args[2] is not CudaArray<float> filter_value || filter_value.Length < InChannels * OutChannels * KernelWidth * 4) {
                throw new ArgumentException(nameof(filter_value));
            }

            if (args[3] is not CudaArray<float> filter_grad || filter_grad.Length < InChannels * OutChannels * KernelWidth * 4) {
