...
namespace TensorShaderCudaBackend.Shaders.Trivector.Convolution.FloatPrecision {
    ...
    public sealed class Deconvolution3D : Shader {
        ...
        public Deconvolution3D(uint inchannels, uint outchannels, uint kwidth, uint kheight, uint kdepth, bool gradmode) {
            ...
            __global__ void trivector_deconvolution_3d(const float3* __restrict__ inmap, float3* __restrict__ outmap, const float4* __restrict__ filter,
            ...
            this.Kernel = new Kernel(code, "trivector_deconvolution_3d");
        }
