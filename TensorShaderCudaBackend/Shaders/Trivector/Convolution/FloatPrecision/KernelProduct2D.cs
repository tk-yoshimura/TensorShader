...
namespace TensorShaderCudaBackend.Shaders.Trivector.Convolution.FloatPrecision {
    ...
    public sealed class KernelProduct2D : Shader {
        ...
        public override void Execute(Stream stream, params object[] args) {
            ...
            filter_grad.ZerosetAsync(stream, InChannels * OutChannels * KernelWidth * KernelHeight * 4);
        ...
        protected override void CheckArgument(params object[] args) {
            ...
            if (args[2] is not CudaArray<float> filter_value || filter_value.Length < InChannels * OutChannels * KernelWidth * KernelHeight * 4) {
                throw new ArgumentException(nameof(filter_value));
            }

            if (args[3] is not CudaArray<float> filter_grad || filter_grad.Length < InChannels * OutChannels * KernelWidth * KernelHeight * 4) {
