...
namespace TensorShaderCudaBackend.Shaders.Trivector.Arithmetric {
    ...
    /// <summary>回転積</summary>
    public sealed class QuaternionMul : Shader {
        /// <summary>識別子</summary>
        ...
        public QuaternionMul() {
            ...
            __global__ void trivector_quaternion_mul(const float3* __restrict__ inmap_vector,
            ...
            this.Kernel = new Kernel(code, "trivector_quaternion_mul");
        }
