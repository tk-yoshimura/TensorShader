    ...
    public sealed class KernelProduct1D : Shader {
        ...
        public override void Execute(Stream stream, params object[] args) {
            ...
            CudaArray<float> dfloat_filter =
                WorkspaceReserver<float>.Request(stream, inmap.DeviceID, index: 0, InChannels * OutChannels * KernelWidth * 2);
            ...
            HorizontalAdd(InChannels * OutChannels * KernelWidth, dfloat_filter, filter, stream);
        }
