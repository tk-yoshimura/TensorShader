...
namespace TensorShaderCudaBackend.Shaders.Convolution.FloatFloatPrecision {
    ...
    public sealed class KernelProduct3D : Shader {
        ...
        public KernelProduct3D(uint inchannels, uint outchannels, uint kwidth, uint kheight, uint kdepth) {
            ...
            __global__ void kernelproduct_3d(const float* __restrict__ inmap, const float* __restrict__ outmap, float* __restrict__ filter,
        ...
        public override void Execute(Stream stream, params object[] args) {
            ...
            CudaArray<float> dfloat_filter =
                WorkspaceReserver<float>.Request(stream, inmap.DeviceID, index: 0, InChannels * OutChannels * KernelWidth * KernelHeight * KernelDepth * 2);
            ...
            HorizontalAdd(InChannels * OutChannels * KernelWidth * KernelHeight * KernelDepth, dfloat_filter, filter, stream);
        }
