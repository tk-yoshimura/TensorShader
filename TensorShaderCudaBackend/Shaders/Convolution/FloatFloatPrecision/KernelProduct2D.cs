    ...
    public sealed class KernelProduct2D : Shader {
        ...
        public override void Execute(Stream stream, params object[] args) {
            ...
            CudaArray<float> dfloat_filter =
                WorkspaceReserver<float>.Request(stream, inmap.DeviceID, index: 0, InChannels * OutChannels * KernelWidth * KernelHeight * 2);
            ...
            HorizontalAdd(InChannels * OutChannels * KernelWidth * KernelHeight, dfloat_filter, filter, stream);
        }
        ...
        protected override void CheckArgument(params object[] args) {
            ...
            if (args[2] is not CudaArray<float> filter || filter.Length < InChannels * OutChannels * KernelWidth * KernelHeight) {
