...
namespace TensorShaderCudaBackend.Shaders.Convolution.FloatFloatPrecision {
    ...
    public sealed class ChannelwiseConvolution1D : Shader {
        ...
        public ChannelwiseConvolution1D(uint channels, uint kwidth) {
            ...
            __global__ void chwise_convolution_1d(const float* __restrict__ inmap, float* __restrict__ outmap, const float* __restrict__ filter) {{
        ...
        protected override void CheckArgument(params object[] args) {
            ...
            if (args[2] is not CudaArray<float> filter || filter.Length < Channels * KernelWidth) {
