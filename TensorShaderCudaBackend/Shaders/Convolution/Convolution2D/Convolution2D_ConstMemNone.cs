...
namespace TensorShaderCudaBackend.Shaders.Convolution {
    ...
    public sealed class Convolution2D_ConstMemNone : Convolution2D_Base {

        /// <summary>コンストラクタ</summary>
        public Convolution2D_ConstMemNone(uint inchannels, uint outchannels, uint kwidth, uint kheight) 
