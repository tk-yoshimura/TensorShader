...
namespace TensorShaderCudaBackend.Shaders.Convolution.CudnnImplement {
    ...
    public sealed class Convolution2D : Shader {
        ...
        public Convolution2D(Cudnn.CudnnController controller) {
        ...
        public override void Execute(Stream stream, params object[] args) {
            ...
            BlockTranspose(inchannels, outchannels, kwidth * kheight, filter, transpose_filter, stream);
        ...
        protected override void CheckArgument(params object[] args) {
            ...
            if (!(args[7] is uint inwidth) || !Limits.CheckWidth(inwidth, kwidth)) {
                throw new ArgumentException(nameof(inwidth));
            }

            if (!(args[8] is uint inheight) || !Limits.CheckHeight(inheight, kheight)) {
                throw new ArgumentException(nameof(inheight));
            }

            if (!(args[9] is uint batches) || !Limits.CheckBatches(batches)) {
            ...
            if (!(args[2] is CudaArray<float> filter) || filter.Length < inchannels * outchannels * kwidth * kheight) {
