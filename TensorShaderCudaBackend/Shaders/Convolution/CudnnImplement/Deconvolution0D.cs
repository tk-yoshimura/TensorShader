...
namespace TensorShaderCudaBackend.Shaders.Convolution.CudnnImplement {
    ...
    public sealed class Deconvolution0D : Shader {
        ...
        public Deconvolution0D(Cudnn.CudnnController controller) {
        ...
        public override void Execute(Stream stream, params object[] args) {
            ...
            using Cudnn.FilterDescriptor filterdesc = new(
                Cudnn.TensorFormat.NHWC, Cudnn.DataType.Float,
                (int)inchannels, (int)outchannels, 1, 1
            );
            ...
            controller.ConvolutionBackwardData(filter, filterdesc, inmap, indesc, convdesc, outmap, outdesc);
        }
