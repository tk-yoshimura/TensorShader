    ...
    public static class Convolution {
        ...
        public static void Dense(uint inchannels, uint outchannels,
            ...
            if (Environment.CudnnEnabled) {
                ...
                Shader cudnn_shader = new Shaders.Convolution.CudnnImplement.Convolution0D(controllers[stream]);
                cudnn_shader.Execute(
                    stream, inmap, outmap, kernel,
                    inchannels, outchannels, batch
                );
        ...
        public static void TransposeDense(uint inchannels, uint outchannels,
            ...
            if (Environment.CudnnEnabled) {
                ...
                Shader cudnn_shader = new Shaders.Convolution.CudnnImplement.Deconvolution0D(controllers[stream]);
                cudnn_shader.Execute(
                    stream, inmap, outmap, kernel,
                    inchannels, outchannels, batch
                );
        ...
        public static void KernelProductDense(uint inchannels, uint outchannels,
            ...
            if (Environment.CudnnEnabled) {
                ...
                Shader cudnn_shader = new Shaders.Convolution.CudnnImplement.KernelProduct0D(controllers[stream]);
                cudnn_shader.Execute(
                    stream, inmap, outmap, kernel,
                    inchannels, outchannels, batch
                );
        ...
        public static void Convolution2D(uint inchannels, uint outchannels, uint inwidth, uint inheight,
            ...
            if (Environment.CudnnEnabled) {
                ...
                Shader cudnn_shader = new Shaders.Convolution.CudnnImplement.Convolution2D(controllers[stream]);
                cudnn_shader.Execute(
                    stream, inmap, outmap, kernel,
                    inchannels, outchannels, kwidth, kheight, inwidth, inheight, batch
                );
        ...
        public static void Deconvolution2D(uint inchannels, uint outchannels, uint inwidth, uint inheight,
            ...
            if (Environment.CudnnEnabled) {
                ...
                Shader cudnn_shader = new Shaders.Convolution.CudnnImplement.Deconvolution2D(controllers[stream]);
                cudnn_shader.Execute(
                    stream, inmap, outmap, kernel,
                    inchannels, outchannels, kwidth, kheight, inwidth, inheight, batch
                );
        ...
        public static void KernelProduct2D(uint inchannels, uint outchannels, uint inwidth, uint inheight,
            ...
            if (Environment.CudnnEnabled) {
                ...
                Shader cudnn_shader = new Shaders.Convolution.CudnnImplement.KernelProduct2D(controllers[stream]);
                cudnn_shader.Execute(
                    stream, inmap, outmap, kernel,
                    inchannels, outchannels, kwidth, kheight, inwidth, inheight, batch
                );
        ...
        public static void Convolution3D(uint inchannels, uint outchannels, uint inwidth, uint inheight, uint indepth,
            ...
            if (Environment.CudnnEnabled) {
                ...
                Shader cudnn_shader = new Shaders.Convolution.CudnnImplement.Convolution3D(controllers[stream]);
                cudnn_shader.Execute(
                    stream, inmap, outmap, kernel,
                    inchannels, outchannels, kwidth, kheight, kdepth, inwidth, inheight, indepth, batch
                );
        ...
        public static void Deconvolution3D(uint inchannels, uint outchannels, uint inwidth, uint inheight, uint indepth,
            ...
            if (Environment.CudnnEnabled) {
                ...
                Shader cudnn_shader = new Shaders.Convolution.CudnnImplement.Deconvolution3D(controllers[stream]);
                cudnn_shader.Execute(
                    stream, inmap, outmap, kernel,
                    inchannels, outchannels, kwidth, kheight, kdepth, inwidth, inheight, indepth, batch
                );
        ...
        public static void KernelProduct3D(uint inchannels, uint outchannels, uint inwidth, uint inheight, uint indepth,
            ...
            if (Environment.CudnnEnabled) {
                ...
                Shader cudnn_shader = new Shaders.Convolution.CudnnImplement.KernelProduct3D(controllers[stream]);
                cudnn_shader.Execute(
                    stream, inmap, outmap, kernel,
                    inchannels, outchannels, kwidth, kheight, kdepth, inwidth, inheight, indepth, batch
                );
        ...
        public static void PointwiseConvolution(uint inchannels, uint outchannels, uint points,
            ...
            if (Environment.CudnnEnabled) {
                ...
                cudnn_shader.Execute(
                    stream, inmap, outmap, kernel,
                    inchannels, outchannels, points * batch
                );
