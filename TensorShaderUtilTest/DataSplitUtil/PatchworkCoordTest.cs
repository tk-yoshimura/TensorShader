...
namespace TensorShaderUtilTest.DataSplitUtil {
    ...
    public class PatchworkCoordTest {
        ...
        public void ExecuteTest() {
            ...
            Assert.AreEqual(0, coord1.SplicingEdges);
            ...
            Assert.AreEqual(0, coord2.SplicingEdges);
            ...
            Assert.AreEqual(1, coord3.SplicingEdges);
            ...
            Assert.AreEqual(0, coord4.SplicingEdges);
            ...
            Assert.AreEqual(0, coord5.SplicingEdges);
            ...
            Assert.AreEqual(2, coord7.SplicingEdges);
            ...
            Assert.AreEqual(2, coord8.SplicingEdges);
            ...
            Assert.AreEqual(2, coord9.SplicingEdges);
            ...
            Assert.AreEqual(2, coord10.SplicingEdges);
            ...
            Assert.AreEqual(0, coord11.SplicingEdges);
