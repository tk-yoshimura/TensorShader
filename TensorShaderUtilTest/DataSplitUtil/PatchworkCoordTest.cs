...
namespace TensorShaderUtilTest.DataSplitUtil {
    ...
    public class PatchworkCoordTest {
        ...
        public void ExecuteTest() {
            PatchworkCoord coord1 = new PatchworkCoord(32, 32, 0);
            ...
            PatchworkCoord coord2 = new PatchworkCoord(33, 32, 0);
            ...
            PatchworkCoord coord3 = new PatchworkCoord(34, 32, 1);
            ...
            PatchworkCoord coord4 = new PatchworkCoord(64, 32, 0);
            ...
            PatchworkCoord coord5 = new PatchworkCoord(65, 32, 0);
            ...
            PatchworkCoord coord6 = new PatchworkCoord(66, 32, 1);
            ...
            PatchworkCoord coord7 = new PatchworkCoord(66, 32, 2);
            ...
            PatchworkCoord coord8 = new PatchworkCoord(87, 32, 2);
            ...
            PatchworkCoord coord9 = new PatchworkCoord(88, 32, 2);
            ...
            PatchworkCoord coord10 = new PatchworkCoord(89, 32, 2);
            ...
            PatchworkCoord coord11 = new PatchworkCoord(30, 32, 0);
        ...
        public void BadCreateTest() {
            Assert.ThrowsException<ArgumentException>(() => {
                PatchworkCoord coord = new PatchworkCoord(0, 32, 0);
            });

            Assert.ThrowsException<ArgumentException>(() => {
                PatchworkCoord coord = new PatchworkCoord(32, 0, 0);
            });

            Assert.ThrowsException<ArgumentException>(() => {
                PatchworkCoord coord = new PatchworkCoord(32, 32, -1);
            });

            Assert.ThrowsException<ArgumentException>(() => {
                PatchworkCoord coord = new PatchworkCoord(33, 32, 16);
            });
        }
    }
}
