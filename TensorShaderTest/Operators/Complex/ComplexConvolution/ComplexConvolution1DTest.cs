...
namespace TensorShaderTest.Operators.Complex {
    ...
    public class ComplexConvolution1DTest {
        ...
        public void SpeedFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/complex_convolution_1d_fp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedFFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/complex_convolution_1d_ffp.nvvp");
            Cuda.Profiler.Start();
