...
namespace TensorShaderTest.Operators.Complex {
    ...
    public class ComplexDeconvolution1DTest {
                    ...
                    foreach (int outchannels in new int[] { 2, 4, 10, 20, 32, 34 }) {
                        foreach (int kwidth in new int[] { 1, 3, 5 }) {
                            foreach (int inwidth in new int[] { kwidth, kwidth * 2, 8, 9, 13, 17, 25 }) {
                                ...
                                ComplexDeconvolution1D ope = new(outwidth, outchannels, inchannels, kwidth, gradmode: false, batch);
        ...
        public void SpeedFPTest() {
            ...
            ComplexDeconvolution1D ope = new(outwidth, outchannels, inchannels, ksize);

            ope.Execute(y_tensor, w_tensor, x_tensor);

            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/complex_deconvolution_1d_fp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedFFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/complex_deconvolution_1d_ffp.nvvp");
            Cuda.Profiler.Start();
        ...
        public static ComplexMap1D Reference(ComplexMap1D y, ComplexFilter1D w, int inw, int kwidth) {
            ...
            ComplexMap1D x = new(inchannels, inw, batch);
