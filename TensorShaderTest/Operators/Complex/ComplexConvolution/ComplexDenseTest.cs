...
namespace TensorShaderTest.Operators.Complex {
    ...
    public class ComplexDenseTest {
            ...
            foreach (int batch in new int[] { 1, 2 }) {
                foreach (int inchannels in new int[] { 2, 4, 10, 20, 32, 34 }) {
                    foreach (int outchannels in new int[] { 2, 4, 10, 20, 32, 34 }) {
                        ...
                        ComplexDense ope = new(inchannels, outchannels, gradmode: false, batch);
        ...
        public void SpeedFPTest() {
            ...
            ComplexDense ope = new(inchannels, outchannels);

            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/complex_dense_fp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedFFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/complex_dense_ffp.nvvp");
            Cuda.Profiler.Start();
        ...
        public static ComplexMap0D Reference(ComplexMap0D x, ComplexFilter0D w) {
            ...
            ComplexMap0D y = new(outchannels, batch);
