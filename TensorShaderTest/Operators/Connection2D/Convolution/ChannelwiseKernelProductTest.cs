...
namespace TensorShaderTest.Operators.Connection2D {
    ...
    public class ChannelwiseKernelProductTest {
                        ...
                        foreach (int kwidth in new int[] { 1, 3, 5 }) {
                            foreach (int inheight in new int[] { 8, 9, 19, 23 }) {
                                foreach (int inwidth in new int[] { 8, 9, 13, 17 }) {
                                    ...
                                    Map2D gy = new(channels, outwidth, outheight, batch, gyval);
                                    ...
                                    OverflowCheckedTensor gy_tensor = new(Shape.Map2D(channels, outwidth, outheight, batch), gyval);

                                    OverflowCheckedTensor gw_tensor = new(Shape.Kernel2D(channels, 1, kwidth, kheight));

                                    ChannelwiseKernelProduct ope = new(inwidth, inheight, channels, kwidth, kheight, batch);
                                    ...
                                    AssertError.Tolerance(gw_expect, gw_actual, 1e-6f, 1e-4f, ref max_err, $"mismatch value {channels},{kwidth},{kheight},{inwidth},{inheight},{batch}");
        ...
        public void SpeedFPTest() {
            ...
            OverflowCheckedTensor gy_tensor = new(Shape.Map2D(channels, outwidth, outheight));

            OverflowCheckedTensor gw_tensor = new(Shape.Kernel2D(channels, 1, ksize, ksize));

            ChannelwiseKernelProduct ope = new(inwidth, inheight, channels, ksize, ksize);

            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/chwise_kernelproduct_2d_fp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedFFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/chwise_kernelproduct_2d_ffp.nvvp");
            Cuda.Profiler.Start();
        ...
        public static Filter2D Reference(Map2D x, Map2D gy, int kwidth, int kheight) {
            ...
            Filter2D w = new(channels, 1, kwidth, kheight);
        ...
        public void ReferenceTest() {
            ...
            Map2D x = new(channels, inwidth, inheight, 1, xval);
            Map2D gy = new(channels, outwidth, outheight, 1, gyval);
