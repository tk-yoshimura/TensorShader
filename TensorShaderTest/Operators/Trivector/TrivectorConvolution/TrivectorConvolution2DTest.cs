...
namespace TensorShaderTest.Operators.Trivector {
    ...
    public class TrivectorConvolution2DTest {
        ...
        public void SpeedFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/trivector_convolution_2d_fp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedFFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/trivector_convolution_2d_ffp.nvvp");
            Cuda.Profiler.Start();
