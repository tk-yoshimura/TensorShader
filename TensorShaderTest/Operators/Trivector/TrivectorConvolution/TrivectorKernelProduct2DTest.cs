...
namespace TensorShaderTest.Operators.Trivector {
    ...
    public class TrivectorKernelProduct2DTest {
                            ...
                            foreach (int kwidth in new int[] { 1, 3, 5 }) {
                                foreach (int inwidth in new int[] { kwidth, kwidth * 2, 8, 9, 13, 17, 25 }) {
                                    foreach (int inheight in new int[] { kheight, kheight * 2, 8, 9, 13, 17, 25 }) {
                                        ...
                                        OverflowCheckedTensor gw_tensor = new(Shape.Kernel2D(inchannels / 3 * 4, outchannels / 3, kwidth, kheight));

                                        TrivectorKernelProduct2D ope = new(inwidth, inheight, inchannels, outchannels, kwidth, kheight, transpose: false, batch);
        ...
        public void SpeedFPTest() {
            ...
            OverflowCheckedTensor gw_tensor = new(Shape.Kernel2D(inchannels / 3 * 4, outchannels / 3, ksize, ksize));

            TrivectorKernelProduct2D ope = new(inwidth, inheight, inchannels, outchannels, ksize, ksize);

            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/trivector_kernelproduct_2d_fp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedFFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/trivector_kernelproduct_2d_ffp.nvvp");
            Cuda.Profiler.Start();
        ...
        public static Quaternion.QuaternionFilter2D Reference(TrivectorMap2D x, TrivectorMap2D gy, Quaternion.QuaternionFilter2D w, int kwidth, int kheight) {
            ...
            Quaternion.QuaternionFilter2D gw = new(inchannels, outchannels, kwidth, kheight);
