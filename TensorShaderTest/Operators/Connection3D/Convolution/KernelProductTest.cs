...
namespace TensorShaderTest.Operators.Connection3D {
    ...
    public class KernelProductTest {
        ...
        public void SpeedFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/kernelproduct_3d_fp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedFFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/kernelproduct_3d_ffp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedCudnnTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/kernelproduct_3d_cudnn.nvvp");
            Cuda.Profiler.Start();
