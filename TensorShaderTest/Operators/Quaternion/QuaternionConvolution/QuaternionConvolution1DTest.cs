...
namespace TensorShaderTest.Operators.Quaternion {
    ...
    public class QuaternionConvolution1DTest {
                    ...
                    foreach (int outchannels in new int[] { 4, 8, 20, 32, 36 }) {
                        foreach (int kwidth in new int[] { 1, 3, 5 }) {
                            foreach (int inwidth in new int[] { kwidth, kwidth * 2, 8, 9, 13, 17, 25 }) {
                                ...
                                QuaternionConvolution1D ope = new(inwidth, inchannels, outchannels, kwidth, gradmode: false, batch);
        ...
        public void SpeedFPTest() {
            ...
            QuaternionConvolution1D ope = new(inwidth, inchannels, outchannels, ksize);

            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/quaternion_convolution_1d_fp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedFFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/quaternion_convolution_1d_ffp.nvvp");
            Cuda.Profiler.Start();
        ...
        public static QuaternionMap1D Reference(QuaternionMap1D x, QuaternionFilter1D w, int kwidth) {
            ...
            QuaternionMap1D y = new(outchannels, outw, batch);
