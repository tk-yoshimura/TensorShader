...
namespace TensorShaderTest.Operators.Quaternion {
    ...
    public class QuaternionDenseTest {
            ...
            foreach (int batch in new int[] { 1, 2 }) {
                foreach (int inchannels in new int[] { 4, 8, 20, 32, 36 }) {
                    foreach (int outchannels in new int[] { 4, 8, 20, 32, 36 }) {
                        ...
                        QuaternionDense ope = new(inchannels, outchannels, gradmode: false, batch);
        ...
        public void SpeedFPTest() {
            ...
            QuaternionDense ope = new(inchannels, outchannels);

            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/quaternion_dense_fp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedFFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/quaternion_dense_ffp.nvvp");
            Cuda.Profiler.Start();
        ...
        public static QuaternionMap0D Reference(QuaternionMap0D x, QuaternionFilter0D w) {
            ...
            QuaternionMap0D y = new(outchannels, batch);
