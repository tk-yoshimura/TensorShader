...
namespace TensorShaderTest.Operators.Quaternion {
    ...
    public class QuaternionKernelProduct1DTest {
        ...
        public void SpeedFPTest() {
            ...
            OverflowCheckedTensor gw_tensor = new(Shape.Kernel1D(inchannels, outchannels / 4, ksize));

            QuaternionKernelProduct1D ope = new(inwidth, inchannels, outchannels, ksize);

            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/quaternion_kernelproduct_1d_fp.nvvp");
            Cuda.Profiler.Start();
        ...
        public void SpeedFFPTest() {
            ...
            Cuda.Profiler.Initialize("../../../../profiler.nvsetting", "../../nvprofiles/quaternion_kernelproduct_1d_ffp.nvvp");
            Cuda.Profiler.Start();
        ...
        public static QuaternionFilter1D Reference(QuaternionMap1D x, QuaternionMap1D gy, int kwidth) {
            ...
            QuaternionFilter1D w = new(inchannels, outchannels, kwidth);
