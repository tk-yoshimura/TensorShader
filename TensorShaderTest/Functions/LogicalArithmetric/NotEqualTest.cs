    ...
    public class NotEqualTest {
        ...
        public void ExecuteTest() {
...

            {
                ...
                OutputNode o = VariableNode.NotEqual(n1, n2).Save();
...

            {
                ...
                OutputNode o = VariableNode.NotEqual(n1, t2).Save();
...

            {
                ...
                OutputNode o = VariableNode.NotEqual(t1, n2).Save();
...

            {
                ...
                OutputNode o = VariableNode.NotEqual(n1, n1).Save();
