    ...
    public class LessThanOrEqualTest {
        ...
        public void ExecuteTest() {
...

            {
                ...
                Tensor o = LessThanOrEqual(t1, t2);
...

            {
                ...
                Tensor o = LessThanOrEqual(t1, t1);
...

            {
                ...
                OutputNode o = VariableNode.LessThanOrEqual(n1, n2).Save();
...

            {
                ...
                OutputNode o = VariableNode.LessThanOrEqual(n1, t2).Save();
...

            {
                ...
                OutputNode o = VariableNode.LessThanOrEqual(t1, n2).Save();
...

            {
                ...
                OutputNode o = VariableNode.LessThanOrEqual(n1, n1).Save();
