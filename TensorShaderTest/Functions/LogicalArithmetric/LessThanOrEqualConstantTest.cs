    ...
    public class LessThanOrEqualConstantTest {
        ...
        public void ExecuteTest() {
...

            {
                ...
                Tensor o = Tensor.LessThanOrEqual(t, 2);
...

            {
                ...
                OutputNode o = VariableNode.LessThanOrEqual(n, 2).Save();
...

            {
                ...
                Tensor o = Tensor.LessThanOrEqual(2, t);
...

            {
                ...
                OutputNode o = VariableNode.LessThanOrEqual(2, n).Save();
