    ...
    public class GreaterThanConstantTest {
        ...
        public void ExecuteTest() {
...

            {
                ...
                Tensor o = Tensor.GreaterThan(t, 2);
...

            {
                ...
                OutputNode o = VariableNode.GreaterThan(n, 2).Save();
...

            {
                ...
                Tensor o = Tensor.GreaterThan(2, t);
...

            {
                ...
                OutputNode o = VariableNode.GreaterThan(2, n).Save();
